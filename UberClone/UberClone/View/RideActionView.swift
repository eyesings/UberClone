...
//  UberClone
//
//  Created by RadCns_KIM_TAEWON on 2022/10/13.
//
...
enum ButtonAction: CustomStringConvertible {
    ...
    var description: String {
        ...
        case .cancel: return "CENCEL RIDE"
...
class RideActionView: UIView {
    ...
    override init(frame: CGRect) {
        ...
        separtorView.anchor(top: uberInfoLabel.bottomAnchor, left: leftAnchor,
                            right: rightAnchor, paddingTop: 4, height: 0.7)
